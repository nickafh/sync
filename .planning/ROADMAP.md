...
- [ ] **Phase 1: Foundation & Infrastructure** - Docker Compose, PostgreSQL schema, Entra registration, JWT auth
- [ ] **Phase 2: Sync Engine Core** - DDG resolution via Graph filter, delta sync, stale handling, throttle retry, logging
...
- [ ] 01-04-PLAN.md -- Next.js frontend with login page, dashboard, sidebar, auth middleware, Sotheby's design system
...
| 2. Sync Engine Core | 0/3 | Not started | - |
